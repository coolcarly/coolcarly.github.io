...
DY = (wt of flour + wt of water)/wt of flour x 100

The water content in the sourdough will affect how the bacteria and yeast behave during fermentation. 

### Having a high DY (Liquid)
When the DY is high (defined as DY=200-220), and the starter is a liquid consistency, the resulting bread will produce more lactic acid leading to more mild flavours. The higher water content makes the breakdown of protein and starches faster due to easier flow of enzymes through the dough. In turn, this faster breakdown makes the dough softer. 
